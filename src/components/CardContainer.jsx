...
export default function CardContainer() {
  return (
    <div className="flex flex-col gap-8 pt-4 max-w-[90vw] sm:flex-row sm:p-4 sm:flex-wrap sm:w-fit mx-auto sm:px-0 sm:gap-4">
       <div className="flex flex-col justify-between gap-2 mx-auto sm:gap-1 sm:mx-0 max-w-fit">
        <Carousel>
          <CarouselContent className="sm:w-74">
