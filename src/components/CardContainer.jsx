...
export default function CardContainer() {
  return (
    <div className="flex flex-col gap-8 pt-4 max-w-[90vw] sm:flex-row sm:p-4 sm:flex-wrap sm:w-fit mx-auto sm:px-0 sm:gap-4 md:mx-auto md:w-full lg:justify-between">
       ...
       <div className="flex flex-col justify-between gap-2 mx-auto sm:gap-1 sm:mx-0 max-w-fit sm:w-[43.7vw] sm:max-w-84 md:w-55 md:flex-1 lg:flex-0 lg:min-w-[28vw]">
        <Carousel>
          <CarouselContent>
